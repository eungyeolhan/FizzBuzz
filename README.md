...
But first, let's get you your own copy of this codebase to work with. TEST
...
- public static void - the header
- for loop using a parenthesis and also having new parameters
